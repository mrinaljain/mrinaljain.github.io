...
function Reffrences() {
  return (
     <div className="box">
      ...
      <blockquote className="p-3 pl-6 mb-3 text-base border-l-4 border-slate-200 dark:border-slate-700">
           <div>
           ...
           < footer className="block text-sm leading-[1.42857143] text-blue-600 dark:text-blue-400">
